...
DHTSpider.prototype.onFindNodeResponse = function(encoded_nodes) {
    var nodes = utils.decodeNodes(encoded_nodes);
...
DHTSpider.prototype.onMessage = function(encoded_msg, rinfo) {
    try {
        var msg = bencode.decode(encoded_msg);
